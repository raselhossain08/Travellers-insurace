    ...
    <div class="flex flex-col items-center justify-start destination">
        ...
        <div class="flex items-center justify-between w-full max-w-md p-4 relative header-area h-[64px]">
            ...
            <div class="content absolute top-0 left-0 w-full flex justify-center h-full items-center">
                <h1 class="text-lg font-semibold text-center">Personal Information</h1>
            </div>
        </div>
        ...
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            <label class="block">Нэр</label>
            <input type="text" placeholder="Анхбаяр" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" />
        </div>
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            <label class="block">Овог</label>
            <input type="text" placeholder="Баянмөнх" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" />
        </div>
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            <label class="block">Мэйл хаяг</label>
            <input type="text" placeholder="ankhbayar.b@gmail.com" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" />
        </div>
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            <label class="block">Регистрийн дугаар</label>
            <input type="text" placeholder="OE02022213" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none" />
        </div>
        <!-- Continue Button -->
