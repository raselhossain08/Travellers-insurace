  ...
  <div class="flex flex-col items-center justify-start destination">
    ...
    >
      ...
      <div class="content absolute top-0 left-0 w-full flex justify-center h-full items-center">
        <h1 class="text-lg font-semibold text-center">Travel duration</h1>
      </div>
    </div>
    ...
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      ...
      <Datepicker v-model="picked" ref="datepicker" @input="updateInput" :readonly="false" />
    </div>
    <!-- End Date -->
    <div class="w-full max-w-md px-4 py-4 form-content relative">
    ...
    <div class="selected-destinations max-w-md w-full px-4 pt-4 pb-10">
      <h1>Includes Covid-19 coverage</h1>
      <div class="coverage-items relative my-2">
        <div class="p-5">
          <h2>Type A $50,000</h2>
          <p>
          ...
          <div class="flex items-center price-box mt-4 pt-2">
            <div class="w-2/4">
              <h5 class="price">Price</h5>
              <h3 class="title pt-3">$252</h3>
            </div>
            <div class="w-2/4 flex items-center justify-end">
              <button type="button" class="get-insured">
                Get insured
          ...
          <div class="absolute top-0 right-0">
            <img src="@/assets/img/effects.png" alt="" />
          </div>
        </div>
      </div>
      <div class="coverage-items relative my-2">
    ...
    <!-- Continue Button -->
    <div class="footer-content w-full py-10">
