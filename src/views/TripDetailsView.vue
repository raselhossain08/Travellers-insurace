  ...
  <div class="flex flex-col items-center justify-start destination">
    ...
    >
      ...
      <div class="content absolute top-0 left-0 w-full flex justify-center h-full items-center">
        <h1 class="text-lg font-semibold text-center">Trip details</h1>
      </div>
    </div>
    ...
    <div class="destination-box max-w-md w-full px-4">
      <h1 class="mb-4">Destinationx Countries:</h1>
      <div class="box w-full flex items-center">
        <span class="offline block"></span>
        <button type="button" class="mx-2">Bahamas, Qatar</button>
      </div>
    </div>
    <!-- Start Date -->
    <div class="flex px-4 py-4 w-full max-w-md">
      <div class="w-2/4 pr-2">
        <div class="w-full form-content relative">
          <label class="block">Coverage starts</label>
          <Datepicker
      ...
      <div class="w-2/4 pl-2">
        <div class="w-full form-content relative">
          <label class="block">Coverage ends</label>
          <Datepicker
            v-model="CoverageEnd"
            ref="datepicker"
            @input="updateInput"
    ...
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      ...
      <input type="text" placeholder="altex1230@gmail.com" class="w-full px-4 py-2" />
    </div>
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      <label class="block">Full name</label>
      <input type="text" placeholder="Walter White" class="w-full px-4 py-2" />
    </div>
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      <label class="block">Date of birth</label>
      <Datepicker v-model="DateOfBirth" ref="datepicker" @input="updateInput" :readonly="false" />
    </div>
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      <label class="block">Gender</label>
      <input type="text" placeholder="Male" class="w-full px-4 py-2" />
    </div>
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      <label class="block">Phone number</label>
      <input type="text" placeholder="86861199" class="w-full px-4 py-2" />
    </div>
    <div class="w-full max-w-md px-4 py-4 form-content relative">
      <label class="block">Address</label>
      <input
        type="text"
        placeholder="УБ хот, БЗД, 1-р хороо 1-р байр, 1-р тоот"
...
const CoverageStart = ref(new Date())
const CoverageEnd = ref(new Date())
...
.price-box {
  border-top: 1.5px solid rgba(247, 247, 248, 1);
