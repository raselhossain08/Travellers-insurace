    ...
    <div class="flex flex-col items-center justify-start destination">
        ...
        <!-- Start Date -->
         <div class="flex px-4 py-4 w-full max-w-md">
            <div class="w-2/4 pr-2">
                <div class="w-full form-content relative">
                    ...
                    <Datepicker v-model="CoverageStart" ref="datepicker" @input="updateInput" :readonly="false" />
                </div>
            </div>
            <div class="w-2/4 pl-2">
                <div class="w-full form-content relative">
                    <label class="block">Coverage ends</label>
                    <Datepicker v-model="CoverageEnd" ref="datepicker" @input="updateInput" :readonly="false" />
                </div>
            </div>
         </div>
         ...
         <div class="w-full max-w-md px-4 py-4 form-content relative">
            ...
            <input type="text" placeholder="altex1230@gmail.com"
        ...
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            ...
            <input type="text" placeholder="86861199"
                class="w-full px-4 py-2 " />
        </div>
        <div class="w-full max-w-md px-4 py-4 form-content relative">
            <label class="block">Address</label>
            <input type="text" placeholder="УБ хот, БЗД, 1-р хороо 1-р байр, 1-р тоот"
                class="w-full px-4 py-2 " />
        </div>
        <!-- End Date -->
        <!-- Continue Button -->
